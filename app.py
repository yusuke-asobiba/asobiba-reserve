...
for chat in st.session_state["chat_logs"]:
    ...
    <div style="display: flex; justify-content: {align}; font-family: 'Meiryo', sans-serif;">
        <div style="{bubble_style}">
           ...
           {'<img src="data:image/png;base64,' + chat['img'] + '" style="width:100%; max-height:100px; object-fit: contain; margin-top:5px;">' if chat['img'] else ''}
        </div>
    </div>
    """

    components_html(html_block, height=300, scrolling=False)
